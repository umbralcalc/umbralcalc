...
- A framework for [simulating and inferring multi-state models with a counting memory which can be applied to pneumococcal carriage](https://nbviewer.jupyter.org/github/umbralcalc/pneumoinfer/blob/master/notebooks/theory-docs.ipynb).
