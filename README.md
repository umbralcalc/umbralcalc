...
- A collection of [published research papers in cosmology, epidemiology and statistical science](https://orcid.org/0000-0001-8778-006X).  
...
- A simulation and inference framework for multi-state models with a counting memory which can be applied to pneumococcal carriage. This work is ongoing. Progress can be followed in this [repo](https://github.com/umbralcalc/pneumoinfer).
