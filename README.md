...
:black_nib: In my free time, I'm co-authoring [an open source book](https://github.com/umbralcalc/diffusing-ideas) which documents an ongoing software development project to create generalised simulation, inference, manipulation and control optimisation tools for stochastic phenomena. It's aimed particularly at mathematically-inclined programmers and computational scientists and you can download the latest version for free [here](https://github.com/umbralcalc/diffusing-ideas/raw/main/book.pdf).
