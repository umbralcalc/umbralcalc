...
:black_nib: Now in my free time, I'm co-authoring [an open source book](https://github.com/umbralcalc/diffusing-ideas) which documents a multi-year software development project to create a generalised modelling framework for stochastic phenomena. It's aimed particularly at mathematically-inclined programmers and computational scientists and you can download the latest version for free [here](https://github.com/umbralcalc/diffusing-ideas/raw/main/book.pdf).
